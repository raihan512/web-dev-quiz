...
const Topic = ({ topic }) => {
    ...
    return (
        <div className='bg-black sm:flex justify-between items-center m-5 rounded-md p-5'>
            ...
            <div className='text-left'>
                ...
                <button
                    onClick={handleTopic}
                    className='bg-green-500 py-2 px-10 rounded-md text-white font-semibold text-lg'
                >Test</button>
            </div>
        </div>
    );
